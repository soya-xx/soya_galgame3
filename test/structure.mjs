...
const routes = [
  ...
  ['END_TRUE', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救', '长老认错人了', '摊牌', '周旋', '为她活', '直取飞升台', '斩契约']],
  ['END_ALLY', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '移开眼', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '愣在原地', '拦下', '给他一次机会', '不去', '把丹药塞给他', '救', '是', '封印面板', '周旋', '为她活', '直取飞升台', '斩契约']],
  ['END_ASH', ['让它进来', '签', '接', '攒着买剑', '装侥幸', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '立刻转身', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '为她活', '直取飞升台', '烧契约']],
  ['END_SLEEP', ['让它进来', '签', '接', '攒着买剑', '装侥幸', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '立刻转身', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '为她活', '直取飞升台', '斩契约']],
  ['END_DEMON', ['关窗', '签', '接', '攒着买剑', '不解释', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '愣在原地', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '为恨活']],
  ['END_LEAVE', ['让它进来', '问清楚再签', '接', '买鱼干', '装侥幸', '移开眼', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '愣在原地', '拦下', '给他一次机会', '不去', '把丹药塞给他', '救', '是', '封印面板', '周旋', '为她活', '带她走，不打了']]
];
