...
const ENDS = ['END_TRUE', 'END_ALLY', 'END_ASH', 'END_SLEEP', 'END_DEMON', 'END_LEAVE', 'END_REFUSE', 'END_ARENA',
  'END_SHEN', 'END_LIU', 'END_XUANYI', 'END_QIAN', 'END_ZHOU', 'END_LUO', 'END_GU', 'END_KING'];
if (ENDS.length < 15) fail(`结局数不足15 (${ENDS.length})`);
else ok(`结局总数 ${ENDS.length} ≥ 15`);
for (const e of ENDS) {
...
const routes = [
  ...
  ['END_TRUE', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救', '长老认错人了', '摊牌', '周旋', '递碗水给他', '为她活', '直取飞升台', '斩契约']],
  ['END_ALLY', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '移开眼', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '愣在原地', '拦下', '给他一次机会', '不去', '把丹药塞给他', '救', '是', '封印面板', '周旋', '递碗水给他', '为她活', '直取飞升台', '斩契约']],
  ['END_ASH', ['让它进来', '签', '接', '攒着买剑', '装侥幸', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '立刻转身', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '由他去', '为她活', '直取飞升台', '烧契约']],
  ['END_SLEEP', ['让它进来', '签', '接', '攒着买剑', '装侥幸', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '立刻转身', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '由他去', '为她活', '直取飞升台', '斩契约']],
  ['END_DEMON', ['关窗', '签', '接', '攒着买剑', '不解释', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '愣在原地', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '由他去', '为恨活']],
  ['END_LEAVE', ['让它进来', '问清楚再签', '接', '买鱼干', '装侥幸', '移开眼', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '愣在原地', '拦下', '给他一次机会', '不去', '把丹药塞给他', '救', '是', '封印面板', '周旋', '递碗水给他', '为她活', '带她走，不打了']],
  /* —— 新增·羁绊结局路线（基于真结局线，替入羁绊选项） —— */
  ['END_SHEN', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '倾囊相授', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救', '长老认错人了', '摊牌', '周旋', '递碗水给他', '为她活', '直取飞升台', '斩契约']],
  ['END_LIU', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救', '认，并交底', '摊牌', '周旋', '递碗水给他', '为她活', '直取飞升台', '斩契约']],
  ['END_XUANYI', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救', '长老认错人了', '摊牌', '递他一问', '递碗水给他', '为她活', '直取飞升台', '斩契约']],
  ['END_QIAN', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救', '长老认错人了', '摊牌', '周旋', '给他活路', '为她活', '直取飞升台', '斩契约']],
  ['END_LUO', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救并护幼', '长老认错人了', '摊牌', '周旋', '递碗水给他', '为她活', '直取飞升台', '斩契约']],
  ['END_ZHOU', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '指点一句', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '陪他守夜', '救', '长老认错人了', '摊牌', '周旋', '递碗水给他', '为她活', '把她托付给周伯', '斩契约']],
  ['END_GU', ['让它进来', '签', '接', '攒着买剑', '装侥幸', '盯着看', '忍住', '锋芒', '不说', '十倍碾过去', '立刻转身', '装没看见', '上座', '尊重他', '转身走', '长老认错人了', '装不知道', '拔剑', '由他去', '为她活', '直取飞升台', '接他的位']],
  ['END_KING', ['让它进来', '问清楚再签', '接', '买鱼干', '不解释', '盯着看', '摸耳朵', '藏拙', '倾囊相授', '钓他抬价', '立刻转身', '拦下', '给他一次机会', '末座', '把丹药塞给他', '救并护幼', '认，并交底', '摊牌', '递他一问', '给他活路', '为她活', '直取飞升台', '斩契约']]
];
